...
public class InternacaoController{
    ...
    public ResponseEntity<List<InternacaoDto>> listaInternacoes(){
        ...
        List<InternacaoDto> internacaoListDTO = internacaoRepository.findAll().stream()
                .map(this::converteParaInternacaoDTO).collect(Collectors.toList());
    ...
    private InternacaoDto converteParaInternacaoDTO(Internacao internacao) {
